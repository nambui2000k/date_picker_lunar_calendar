...
class DatePickerLunarCalendarWidget extends StatefulWidget {
  ...
  @override
  State<DatePickerLunarCalendarWidget> createState() => _DatePickerLunarCalendarWidgetState();
}

class _DatePickerLunarCalendarWidgetState extends State<DatePickerLunarCalendarWidget> {
  ...
  @override
  void initState() {
    dateSelected = DateTime(widget.dateSelected.year,widget.dateSelected.month,widget.dateSelected.day);
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              InkWell(
                  ...
                  child: Icon(CupertinoIcons.chevron_left_2,size: 18,)),
              InkWell(
                onTap: (){
                  if(month - 1 <= 0){
                    month = 12;
              ...
              Expanded(
                child: Center(
                  child: Text("Tháng "+DateFormat('MM yyyy').format(DateTime(year,month,1)),style: TextStyle(
                      fontSize: 16,
              ...
              InkWell(
                  ...
                  child: Icon(CupertinoIcons.chevron_right_2,size: 18,)),
            ],
          ),
          SizedBox(height: 20,),
          Divider(thickness: 1,height: 1,color: clrF3F4F6,),
          Column(
            children: [
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 12),
                child: Wrap(
                  children: [DateTime.monday,DateTime.tuesday,DateTime.wednesday,DateTime.thursday,DateTime.friday,DateTime.saturday,DateTime.sunday]
                      .map<Widget>((dow) => Container(
                    width: (width-130)/7,
                    child: Center(child: Text(getDisplayDayOfWeek(dow),style: TextStyle(
                        fontSize: 13,
                        fontWeight: FontWeight.w600,
                        color: Colors.grey
                    ),)),
              ...
              Padding(
                ...
                child: Wrap(
                  ...
                  children: days
                      .map<Widget>((day) => Builder(
                      builder: (context) {

                        if(day == null){
                          return Container(width: (width-130)/7,);
                        }
                          ...
                          child: Container(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  color: !dateSelected.isAtSameMomentAs(day)?Colors.white: Colors.blue
                              ),
                              child: Center(
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Text(DateFormat("d").format(day),style: TextStyle(
                                        fontSize: 16,
                                        // fontWeight: FontWeight.w600,
                                        color: dateSelected.isAtSameMomentAs(day)?Colors.white:((isAfterFuture|| isBeforeFuture)?Colors.grey:Colors.black)),),
                                    Builder(
                                      builder: (context) {
                                        Lunar lunarDay =LunarSolarConverter.solarToLunar(Solar(solarYear: day.year, solarMonth: day.month, solarDay: day.day));
                                        return Text("${lunarDay.lunarDay}/${lunarDay.lunarMonth}",style: TextStyle(
                                          fontSize: 12,
                                            color: dateSelected.isAtSameMomentAs(day)?Colors.white:((isAfterFuture|| isBeforeFuture)?Colors.grey:Colors.grey)
                                        ),);
                                      }
                                    )
                                  ],
          ...
          Row(
            ...
            children: [
              Expanded(
                child: ButtonCustom(title: DateFormat("dd/MM/yyyy").format(dateSelected),
                  onClick: () {
